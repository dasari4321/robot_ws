...
def generate_launch_description():
    ...
    default_model_path = os.path.join(pkg_share, 'src', 'description', 'model.sdf.xacro')
    default_rviz_config_path = os.path.join(pkg_share, 'rviz', 'config_old.rviz')
