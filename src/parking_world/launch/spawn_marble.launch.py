...
def generate_launch_description():
    sim_dir = get_package_share_directory('parking_world')
    desc_dir = get_package_share_directory('parking_car')
        ...
        parameters=[
            {
                'config_file': os.path.join(
                    sim_dir, 'configs', 'marble_bridge.yaml'
                ),
