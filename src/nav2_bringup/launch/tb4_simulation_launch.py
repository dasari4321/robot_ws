...
def generate_launch_description():
    ...
    ld.add_action(gz_robot) #spawn
    ld.add_action(gazebo_server) #world
    ld.add_action(gazebo_client) #gz gui

    # Add the actions to launch all of the navigation nodes
    ld.add_action(start_robot_state_publisher_cmd) #model
    ld.add_action(rviz_cmd) #rviz gui
    ld.add_action(bringup_cmd) #nav
